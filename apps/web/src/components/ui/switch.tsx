...
/**
 * shadcn/ui style Switch backed by @radix-ui/react-switch. Used for the HD/4K
 * upscale toggle (design "True HD: ReviewView has an explicit optional upscale
 * toggle default OFF") and any boolean options.
 */
